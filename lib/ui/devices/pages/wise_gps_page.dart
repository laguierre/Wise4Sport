                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: TextStyle(fontSize: kFontSizePageLabelData),
                          ),
                        ],
                      )),
                  Container(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Expanded(
                                  flex: 1,
                                  child: Text('LAT: ' + WiseGPSData.getLAT(),
                                      style: TextStyle(
                                          fontSize: kFontSizePageLabelData))),
                              Expanded(
                                  flex: 1,
                                  child: Text('LONG: ' + WiseGPSData.getLONG(),
                                      style: TextStyle(
                                          fontSize: kFontSizePageLabelData)))
                            ],
                          )
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Expanded(
                                  child: Text('aACC: ' + WiseGPSData.getaAcc(),
                                      style: TextStyle(
                                          fontSize:
                                              kFontSizePageLabelData * 0.8))),
                              Expanded(
                                  child: Text('sACC: ' + WiseGPSData.getsAcc(),
                                      style: TextStyle(
                                          fontSize:
                                              kFontSizePageLabelData * 0.8))),
                              Expanded(
                                  child: Text('vACC: ' + WiseGPSData.getvAcc(),
                                      style: TextStyle(
                                          fontSize:
                                              kFontSizePageLabelData * 0.8)))
                            ],
